...
text_content = '''Test description for Classification'''

class group1:
    text_content = '''>   **About the Model & Algorithm**

              Classification is a supervised learning algorithm. Given a single feature, a line is fit that
...
###***content group1
class group2:
    text_content = '''>  **Introduction to the Dataset**
...
class group3:
    text_content = '''> **Exploratory Data Analysis of Sales Data**
    ...
    def getLayout():
        ...
        return layout0###***content group3

class group4:
    text_content = '''               
>   **Visual Representation of the Classification Model**
              ...
              Feel free to move the hyperplane around to different angles, to get a better understand the 
...
registry['group1'] = group1
groups.append('group2')
registry['group2'] = group2
groups.append('group3')
registry['group3'] = group3
groups.append('group4')
registry['group4'] = group4
groups.append('group5')
registry['group5'] = group5
groups.append('group6')
registry['group6'] = group6
datadoc_title = 'Demonstrating Classification Algorithms'
import dash
...
layout = html.Div([
        ...
        html.H1(children=datadoc_title),
